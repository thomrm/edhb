        ...
        <div class="filters-group">
            <fieldset class="filter filter--color">
                <div class="filter-group">
                    <input type="checkbox" id="color-w" name="White" bind:checked={colorW} on:change={filterCards} />
                    ...
                    <input type="checkbox" id="color-u" name="Blue" bind:checked={colorU} on:change={filterCards} />
                    ...
                    <input type="checkbox" id="color-b" name="Black" bind:checked={colorB} on:change={filterCards} />
                    ...
                    <input type="checkbox" id="color-r" name="Red" bind:checked={colorR} on:change={filterCards} />
                    ...
                    <input type="checkbox" id="color-g" name="Green" bind:checked={colorG} on:change={filterCards} />
                    ...
                    <input type="checkbox" id="color-c" name="Colorless" bind:checked={colorC} on:change={filterCards} />
